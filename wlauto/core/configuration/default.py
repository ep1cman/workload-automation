from wlauto.core.configuration.configuration import CoreConfiguration, RunConfiguration
...
def generate_default_config(path):
    with open(path, 'w') as output:
        for param in CoreConfiguration.config_points + RunConfiguration.config_points:
